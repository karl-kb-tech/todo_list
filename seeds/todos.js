  ...
  return knex('todos').del()
    .then(function () {
      ...
      return knex('todos').insert([
        ...
        { id: 2, task: 'taskValue2', priority: 2, category: 'garden', is_complete: true, due_at: 1551096000 },
        ...
        { id: 11, task: 'taskValue3', priority: 4, category: 'work', is_complete: true, due_at: 1551096000 },
        { id: 12, task: 'taskValue3', priority: 4, category: 'work', is_complete: false, due_at: 1551096000 },
      ]);
    });
};